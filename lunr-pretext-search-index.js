...
},
{
  ...
  "number": "20.0.5",
  "title": "",
  "body": "  Consider the (commutative) ring and abelian group (under addition) . We have that is an -module. Indeed, for any and , we know that is a real number and is a polynomial in with real coefficients. The module action is given by the multiplication where we think of as a constant polynomial. What else needs to be shown?   "
},
{
  "id": "ch-Modules-9",
  "level": "2",
...
},
{
  ...
  "number": "20.20.B",
  "title": "",
  "body": "  Here are some basic properties of modules. For each, let be a ring with identity, and a left -module.    Show that and for all , where denotes the inverse of in .    Show that for all where denotes the identity element in .    Assume that for some and . Prove that does not have a left inverse, i.e. there is no element such that .     "
},
{
